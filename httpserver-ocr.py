...
class HTTPServerHandler(BaseHTTPRequestHandler):
    ...
    def do_POST(self):         # 处理post请求
        ...
        # 将解析出的文件字节, 保存到本地
        with open("test/ocr.jpg", "wb") as w:
            w.write(file_data)
        ocr_res = ocr_demo("test/ocr.jpg")
...
if __name__ == '__main__':
    try:
        server = HTTPServer(('127.0.0.1', 12345), HTTPServerHandler)
        print("Starting server, listen at: 12345")
